...
export const metadata: Metadata = {
  ...
  description: "A field guide to the 16 cities hosting the FIFA World Cup 2026.",
};
    ...
    <PageShell>
      ...
      <ContentContainer>
        <PageHero
          ...
          title={<>SIXTEEN CITIES. <span className="text-gold">ONE WORLD.</span></>}
          icon={Building2}
          subtitle="A travel-minded field guide to the stadiums, streets, and local rhythms surrounding World Cup 2026."
          stats={
            <>
              <StatCard value={HOST_CITIES.length} label="Host cities" icon={MapPin} />
              <StatCard value={3} label="Host nations" icon={Globe2} accent="text-gold" />

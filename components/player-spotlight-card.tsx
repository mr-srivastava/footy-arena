...
export function PlayerSpotlightCard({
  ...
  return (
    <Link
      href={href}
      className="surface-panel-elevated group relative block h-full min-h-[34rem] overflow-hidden rounded-2xl border border-line-strong bg-artifact shadow-card"
    >
      {image ? (
